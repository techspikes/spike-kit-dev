    ...
    assert.throws(
      ...
      error => {
        ...
        const expectedIssues = [
          ...
          'claims.shipment.x-relational-db-schema must be an object',
          'claims.payment.x-relational-db-schema.unsupportedTopMember is not a supported x-relational-db-schema member',
          'claims.payment.x-relational-db-schema.types must be an object',
          'claims.payment.x-relational-db-schema.keys must be an object',
          'claims.payment.x-relational-db-schema.constraints must be an object',
          'claims.payment.x-relational-db-schema.indexes must be an array',
          'claims.payment.x-relational-db-schema.names must be an object',
          'claims.returnRequest.x-relational-db-schema.keys.unknownMember is not a supported x-relational-db-schema member',
          'claims.coupon.x-relational-db-schema.constraints.check must be an array',
          'claims.coupon.x-relational-db-schema.constraints.unique[0] must have a non-empty columns array and, when present, a non-empty name',
          'claims.coupon.x-relational-db-schema.constraints.unique[1] must have a non-empty columns array and, when present, a non-empty name',
          'claims.coupon.x-relational-db-schema.constraints.unique[2].columns references unknown column doesNotExist',
          'claims.coupon.x-relational-db-schema.names.tables must be an object',
          'claims.coupon.x-relational-db-schema.names.columns must be an object',
          'claims.warehouse.x-relational-db-schema.names.tables.warehouse must be a non-empty string'
        ]
